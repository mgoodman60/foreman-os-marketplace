---
description: Generate an interactive project dashboard from daily report history
...
Read the project-dashboard skill at `${CLAUDE_PLUGIN_ROOT}/skills/project-dashboard/SKILL.md` before proceeding. If available, also read the `web-artifacts-builder` Cowork skill for building rich interactive HTML dashboards with React and Tailwind CSS.
